...
7. 녹취록에 "화자 1:", "화자 2:"와 같은 화자 구분이 포함된 경우, 이를 발언 흐름과 논의 맥락 파악에 참고하세요. 단, 화자 번호가 없거나 모든 발언이 한 화자로만 표시된 경우에는 화자 정보를 억지로 해석하지 말고 전체 회의 맥락 중심으로 정리하세요. 화자 번호를 실제 참석자 이름으로 추정하거나 단정하지 마세요.
